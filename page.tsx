...
<header className="fixed top-0 left-0 right-0 bg-white border-b shadow-sm z-50">
  <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
    <div className="flex items-center">
      <Image 
        src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202025-01-11%20at%209.22.24%E2%80%AFAM-oNXymuMLXwqlH50yzM4tD9l9SNO2C7.png"
        alt="LifelongAI"
        width={140}
        height={32}
    ...
    <MobileMenu />
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="text-center lg:text-left space-y-6">
              ...
              <p className="text-xl md:text-2xl text-gray-600 max-w-2xl mx-auto lg:mx-0 mb-8">
                Providing employment and training opportunities in the Artificial Intelligence sector
              </p>
              <Button 
                size="lg" 
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <Card>
              <CardContent className="p-6 flex flex-col items-center text-center">
                ...
                <p className="text-gray-600">Professional Skills Development</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 flex flex-col items-center text-center">
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-lg text-gray-600 text-center">
              Jordan hosts 1.3 million Syrian Refugees, the majority of whom lack the sufficient professional 
              skills to meet the market demands.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            <div className="space-y-6">
              ...
              <p className="text-gray-600">
                The AI industry needs thousands of people who can manually perform specific annotation 
                functions across billions of images, in order to enhance the accuracy of AI solutions, 
                e.g. self-driving car technologies.
              </p>
            </div>
            <div className="space-y-6">
              <h3 className="text-xl font-semibold">Our Approach</h3>
              <p className="text-gray-600">
                Lifelong AI provides training and employment for refugees in Jordan to perform data 
                labeling activities, focusing on the most vulnerable refugees, especially women who 
                lost their husbands in the war and high school students who lost a parent in the war.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                description: "Provides overall guidance and oversees international development. CEO of Deepen AI and former product manager at Google."
              },
              {
                name: "Mujahid Sarsur",
                role: "Co-Founder & Managing Director",
                description: "Runs the operations in Jordan. Former Google employee managing the Middle East and Africa region for the Legal Removals team."
              },
              {
                name: "Tariq Jalili",
                role: "Co-Founder & Director of Development",
                description: "Manages partnerships with twenty years of business Development experience with IBM, Symantec, and Commvault."
              },
              {
                name: "Ismael Rumzan",
                role: "Co-Founder & Director of Technology and Training",
                description: "Oversees technology and training with twenty years of experience in educational technology in Canada and Jordan."
              }
            ].map((member, index) => (
              <Card key={index}>
      ...
      <footer className="py-6 border-t">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center text-sm text-gray-600">
          ...
          <p className="mt-2">(Lifelong AI unfortunately closed down during the 2020 Covid pandemic)</p>
        </div>
      </footer>
      </div>
    </div>
